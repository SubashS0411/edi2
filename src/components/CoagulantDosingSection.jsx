...
const CoagulantDosingSection = ({ data, setData, calculations }) => {
  ...
  if (!data.required) {
    return (
      <div className="border border-slate-200 rounded p-3 mb-3 bg-slate-50 flex justify-between items-center opacity-70">
        <span className="font-semibold text-slate-700">Coagulant Dosing System</span>
  ...
  return (
    <div className="border border-emerald-100 rounded-lg p-4 mb-4 bg-white shadow-sm">
      <div className="flex justify-between items-center mb-3 pb-2 border-b border-slate-100 gap-2">
        <h4 className="font-bold text-emerald-800">Coagulant Dosing System</h4>
      ...
      <div className="grid grid-cols-2 gap-4 mb-4 bg-slate-50 p-3 rounded border border-slate-100">
        <InputField label="Coagulant PPM" value={data.coagulantPpm} onChange={v => handleParamChange('coagulantPpm', v)} />
        <InputField label="Retention Time (hrs)" value={data.retentionHours} onChange={v => handleParamChange('retentionHours', v)} />
      </div>

      {calculations && (
        <div className="bg-blue-50 border border-blue-100 rounded p-3 mb-4 text-sm text-blue-900 grid grid-cols-2 gap-4">
           <div className="flex flex-col"><span className="text-xs font-semibold text-blue-700">Coagulant Req</span><span className="font-bold">{calculations.coagulantReqKgDay} kg/day</span></div>
...
export default CoagulantDosingSection;
