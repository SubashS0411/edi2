...
const AirBlowerSection = ({ initialBOD, initialBODRemoval, onDataChange }) => {
  ...
  }, [bodInput, bodRemovalInput, selectedBlowerSize]);
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-blue-50 p-4 rounded-md border border-blue-100">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center pt-1">
              <span className="text-sm font-bold text-blue-800">Hourly Air Req (Nm³/hr):</span>
        ...
        <div className="space-y-4">
          <div className="bg-slate-50 p-4 rounded-md border border-slate-200">
            ...
            {selectedBlowerSize && (
              <div className="mt-3 p-2 bg-white rounded border border-slate-200 shadow-sm">
