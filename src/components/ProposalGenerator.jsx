...
import { ArrowRight, ArrowLeft, Loader2, AlertTriangle, AlertCircle, FileText } from 'lucide-react';
...
const Step1 = ({ 
  ...
  // Generate Anaerobic Diameter Options (2.0 to 30.0 with 0.1 increments)
  const diameterOptions = Array.from({length: 281}, (_, i) => (2 + i * 0.1).toFixed(1));
  
  // Generate Anaerobic Height Options (3 to 30)
  const heightOptions = Array.from({length: 28}, (_, i) => (3 + i).toString());
...
const ProposalGenerator = () => {
  ...
  const [clientInfo, setClientInfo] = useState({
    clientName: '', industry: 'Paper', rawMaterial: '', productionCapacity: '', rawMaterialQty: '', finalProducts: '', toxicElements: '', address: '', specificCOD: '50', loopWaterCOD: '1500', calcCODLoad: '', calcFlow: '', inletSCODLoad: '', anaerobicSCODLoad: '', inletBODLoad: '', anaerobicBODLoad: '', inletNLoad: '', anaerobicNLoad: '', inletPLoad: '', anaerobicPLoad: '', tssRemovedKg: '',
  ...
  const [anaerobicFeedPump, setAnaerobicFeedPump] = useState({ required: true, capacity: '', moc: 'CI/SS304', type: 'Centrifugal Semi-open', qty: '2 (1W+1S)', make: 'KSB/Kirloskar/Johnson/Equivalent', head: '30m', power: '', scope: 'EDI' });
  const [biomassPump, setBiomassPump] = useState({ required: true, capacity: '10', head: '24m', moc: 'Nitrile rubber', type: 'Positive displacement pump', qty: '1', make: 'Netch/Hydroprokav/EQT', power: '2.2 kW', scope: 'EDI' });
  const [biogasFlare, setBiogasFlare] = useState({ required: true, capacity: '', height: '10', head: '10m', moc: 'MS Structure / SS304 Line', make: 'Alliance thermal/Super combustion/Tectiko', scope: 'EDI' });
  ...
  const [aerators, setAerators] = useState({ required: true, type: 'Surface aerator', moc: 'SS304', power: '5', qty: '2', make: 'Indofab', scope: 'EDI' });
  const [airBlower, setAirBlower] = useState({ required: true, capacity: '', make: 'KPT', type: 'Tri lobe', qty: '2', head: '5000', totalAirReq: '', scope: 'EDI' });
  ...
  const [daf, setDaf] = useState({ required: true, flow: '', inletTSS: '', outletTSS: '', tssRemovedTons: '', tssRemovedKg: '', make: 'Krofta/DAFTech/Ishan/Kpack', qty: '1', hpPumpCapacity: '', hpPumpMake: 'KSB/Kirloskar/Johnson/Equivalent', hpPumpHead: '60', hpPumpMOC: 'CI/SS304', hpPumpType: 'Open Impeller/Centrifugal', hpPumpQty: '2 (1W+1S)', airCompCapacity: '', airCompMake: 'Atlas Copco/Equivalent', airCompPressure: '6', airCompMOC: 'SS304', airCompQty: '2 (1W+1S)', scope: 'EDI' });
  ...
  const [dosingSystems, setDosingSystems] = useState({
    'Urea': { required: true, pump: { capacity: '10', type: 'Diaphragm', moc: 'PP', make: 'Miltonroy', qty: defaultPumpQty, scope: 'EDI' }, tank: { capacity: '500', type: 'Vertical', moc: 'Select MOC', make: 'Sintex/EQT', qty: '1', scope: 'EDI' }, agitator: { capacity: 'For 500L', type: 'Turbine', moc: 'SS316', make: 'Ceecons/Verito/EQT', qty: '1', rpm: '80-90', scope: 'EDI' } },
    'Phosphoric Acid': { required: true, pump: { capacity: '10', type: 'Diaphragm', moc: 'PP', make: 'Miltonroy', qty: defaultPumpQty, scope: 'EDI' }, tank: { capacity: '500', type: 'Vertical', moc: 'Select MOC', make: 'Sintex/EQT', qty: '1', scope: 'EDI' }, agitator: null },
    'DAP': { required: true, pump: { capacity: '10', type: 'Diaphragm', moc: 'PP', make: 'Miltonroy', qty: defaultPumpQty, scope: 'EDI' }, tank: { capacity: '500', type: 'Vertical', moc: 'Select MOC', make: 'Sintex/EQT', qty: '1', scope: 'EDI' }, agitator: { capacity: 'For 500L', type: 'Turbine', moc: 'SS316', make: 'Ceecons/Verito/EQT', qty: '1', rpm: '80-90', scope: 'EDI' } }, // New DAP System
    'Caustic': { required: true, pump: { capacity: '10', type: 'Diaphragm', moc: 'SS316', make: 'Miltonroy', qty: defaultPumpQty, scope: 'EDI' }, tank: { capacity: '500', type: 'Vertical', moc: 'MS', make: '', qty: '1', scope: 'EDI' }, agitator: { capacity: 'For 500L', type: 'Turbine', moc: 'SS316', make: 'Ceecons/Verito/EQT', qty: '1', rpm: '80-90', scope: 'EDI' }, prepTank: { volume: '200', moc: 'MS', agitatorRpm: '80-90', agitatorType: 'Turbine' } },
    'HCl': { required: true, pump: { capacity: '10', type: 'Diaphragm', moc: 'PP', make: 'Miltonroy', qty: defaultPumpQty }, tank: { capacity: '500', type: 'Vertical', moc: 'Select MOC', make: 'Sintex/EQT', qty: '1', fumeAbsorption: 'Yes' }, agitator: null },
    'Micronutrients': { required: true, pump: { capacity: '10', type: 'Diaphragm', moc: 'PP', make: 'Miltonroy', qty: defaultPumpQty }, tank: { capacity: '500', type: 'Vertical', moc: 'Select MOC', make: 'Sintex/EQT', qty: '1' }, agitator: { capacity: 'For 500L', type: 'Turbine', moc: 'SS316', make: 'Ceecons/Verito/EQT', qty: '1', rpm: '80-90' } },
    'Poly': { required: false, pump: { capacity: '10', type: 'Diaphragm', moc: 'PP', make: 'Miltonroy', qty: defaultPumpQty }, tank: { capacity: '500', type: 'Vertical', moc: 'Select MOC', make: 'Sintex/EQT', qty: '1', rpm: '80-90', fixedSpeed: true } }
  });
  ...
  const handleGenerateProposal = () => {
    ...
    // In a real application, this 'allData' would be sent to a backend service
    // for document generation and download, or stored.
    // For now, we simulate a successful generation with a toast notification.
    console.log("Proposal data prepared for generation:", allData);
    toast({
      title: "Proposal Data Prepared",
      description: "The proposal data has been successfully prepared. A full document download feature would be implemented via a backend service.",
      variant: "success"
    });
  };
      ...
      <div className="mt-6 pt-4 border-t border-slate-200 flex justify-between items-center bg-white">
        ...
        {step < 2 ? (
          ...
          <Button onClick={handleGenerateProposal} className="bg-emerald-600 hover:bg-emerald-700 text-white flex items-center">
            <FileText className="w-4 h-4 mr-2" /> Generate Proposal Data
          </Button>
        )}
      </div>
    </div>
