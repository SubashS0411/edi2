...
const SludgeHandlingSection = ({ 
  ...
  const PUMP_MOC_OPTIONS = ['CI', 'Nitrile Rubber', 'SS', 'Other'];
              ...
              <div className="space-y-4">
                  ...
                  <SpecsSection title="Prep Tank Agitator" icon={Zap}>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                          ...
                          <InputField label="Qty" type="number" value={data.prepAgitatorSpecs?.qty} onChange={(v) => handleNestedChange('prepAgitatorSpecs', 'qty', v)} />
              ...
              <div className="space-y-4">
                  ...
                  <SpecsSection title="Dosing Tank Agitator" icon={Zap}>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                          ...
                          <InputField label="Qty" type="number" value={data.dosingAgitatorSpecs?.qty} onChange={(v) => handleNestedChange('dosingAgitatorSpecs', 'qty', v)} />
